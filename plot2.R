...
totalEmissions <- aggregate(dataBaltimore$Emissions, list(dataBaltimore$year), FUN = "sum")
plot(totalEmissions, type = "l", xlab = "Year", main = "Total PM2.5 Emissions in Baltimore City (1999-2008)", 
     ylab = "Total PM2.5 Emissions")
dev.off()

message("Done! Check ./plots/ directory to find plot2.png file")